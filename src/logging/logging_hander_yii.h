 ...
 *
 */
#ifndef SKYWALKING_YII_LOGGING_HANDER_H
#define SKYWALKING_YII_LOGGING_HANDER_H
#include "src/logging/logging_data.h"
#include "src/logging/logging_common.h"
#include <vector>

class YiiLoggingHander : public LoggingHander {
    public:
        YiiLoggingHander(char *yii_target_name);
