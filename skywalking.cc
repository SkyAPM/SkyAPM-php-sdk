...
PHP_INI_BEGIN()
	...
	STD_PHP_INI_ENTRY("skywalking.grpc_deadline", "1500", PHP_INI_ALL, OnUpdateLong, grpc_deadline, zend_skywalking_globals, skywalking_globals)
...
static void php_skywalking_init_globals(zend_skywalking_globals *skywalking_globals) {
    ...
    skywalking_globals->grpc_deadline = 0;
